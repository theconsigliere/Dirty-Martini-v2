...
<div id="page" class="site">
	...
	<header id="masthead" class="header-new">
	

		<div class="container flex justify-between items-end items-center-l">
			...
			<h6 class='rw hashtog pr6-l black'>#shakingupmarketing</h6>
			<!-- svg toggle icon -->
			<div onclick="openNav()">
			<svg style='fill:black !important;' class='db menu-open' enable-background="new 0 0 384.97 384.97" height="512" viewBox="0 0 384.97 384.97" width="512" xmlns="http://www.w3.org/2000/svg">
		...
		<nav id="site-navigation" class="main-navigation">
			...
			<div class="site-top flex justify-between items-end items-center-l">
